...
int main(){
	...
	std::cout << "ÈþÊ°Èþ»­Éú" << std::endl;
	std::cout << ChineseConvertPinYinAllSpell("ÈþÊ°Èþ»­Éú") << std::endl;
	std::cout << ChineseConvertPinYinInitials("ÈþÊ°Èþ»­Éú") << std::endl;

	std::cout << std::endl;

	std::cout << "¼ð¾¡º®Ö¦²»¿ÏÆÜ ¼ÅÄ¯É³ÖÞÀä" << std::endl;
	std::cout << ChineseConvertPinYinAllSpell("¼ð¾¡º®Ö¦²»¿ÏÆÜ ¼ÅÄ¯É³ÖÞÀä") << std::endl;
	std::cout << ChineseConvertPinYinInitials("¼ð¾¡º®Ö¦²»¿ÏÆÜ ¼ÅÄ¯É³ÖÞÀä") << std::endl;
