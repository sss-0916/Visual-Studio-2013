...
while True:
    ...
    for y in range(120):
        ...
        #z = 3.365579 * math.pow(10, -12) * math.pow(y * 5, 6) - \
        #    9.493974 * math.pow(10, -9) * math.pow(y * 5, 5) + \
        #    1.079795 * math.pow(10, -5) * math.pow(y * 5, 4) - \
        #    6.407496 * math.pow(10, -3) * math.pow(y * 5, 3) +  \
        #    2.11638 * math.pow(y * 5, 2) - \
        #    3.752817 * math.pow(10, 2) * y * 5 + 29193.08
        z = 5.927873 * math.pow(10, -12) * math.pow(y * 5, 6) - \
            1.462346 * math.pow(10, -8) * math.pow(y * 5, 5) + \
            1.483745 * math.pow(10, -5) * math.pow(y * 5, 4) - \
            7.981916 * math.pow(10, -3) * math.pow(y * 5, 3) +  \
            2.445249 * math.pow(y * 5, 2) - \
            4.233364 * math.pow(10, 2) * y * 5 + 3.68638 * math.pow(10, 4)
        #z = 3 * math.pow(10, -12) * math.pow(y, 6) - \
        #    9 * math.pow(10, -9) * math.pow(y, 5) + \
        #    1 * math.pow(10, -5) * math.pow(y, 4) - \
        #    6.4 * math.pow(10, -3) * math.pow(y, 3) +  \
        #    2.1164 * math.pow(y, 2) - \
        #    375.28 * math.pow(10, 2) * y + 29193
        #print(z)
        temp = cut_threeD[y, :]
        temp[temp > z] = -1
