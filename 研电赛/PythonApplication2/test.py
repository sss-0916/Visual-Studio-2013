...
while True:
    ...
    #sampling_threeD[sampling_threeD < 0] = 26000
    # 转成无符号整型
    ...
    # 采样后效果显示
    #sampling_result = sampling_result / 7.88
    ...
    #distance_sort_show = distance_sort_show / 7.88
